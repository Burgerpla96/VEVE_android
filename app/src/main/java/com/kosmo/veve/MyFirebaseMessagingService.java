...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendRegistrationToServer(String token){
        ...
        //new AsyncToServer().execute("http://192.168.0.141:8080/veve/fcm","token="+token);/Admin/fcm.do
        new AsyncToServer().execute("http://172.20.10.4:8080/veve/Admin/fcm.do","token="+token);
        Log.d("token?????","???");
    }////////////sendRegistrationToServer
    */

    private void sendRegistrationToServer(String token){
        new AsyncToServer().execute("http://192.168.0.25:8080/veve/Admin/fcm.do","token="+token);
    }
