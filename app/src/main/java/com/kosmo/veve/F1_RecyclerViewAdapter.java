...
public class F1_RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public F1_RecyclerViewAdapter(List<GallaryBoard> gb_List,List<GallaryLike> glb_list,List<GallaryScrap> gs_List,List<GallaryFile> gf_List,Context context ) {
        gbList = gb_List;
        glbList = glb_list;
        gsList = gs_List;
        gfList = gf_List;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof ItemViewHolder) {
            ...
            /*F1_ViewPagerAdapter viewPagerAdapter = new F1_ViewPagerAdapter(gbList,gfList,context);
    ...
    public void populateItemRows(ItemViewHolder viewHolder, int position) {
        ...
        GallaryFile gf_list = gfList.get(position);
        ...
        new DownloadFilesTask(gf_list.getF_name(),viewHolder.userFile).execute();
        ...
        viewHolder.comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("f_name",gfList.get(position).getF_name());
                v.getContext().startActivity(intent);
            }
        });

        viewHolder.heart_count.setText("좋아요 " + gb_list.getHeartCount() + "개");
        if (gb_list.getUserID().equals(glb_list.getUserID()) && gb_list.getHeartCount() > 0) {
        ...
        if (gb_list.getUserID().equals(gs_list.getUserID()) && gb_list.getScrapCount() > 0) {
